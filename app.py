...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("👨‍💻 Developed by: **Bhawna Sahu**")
    st.markdown("🔗 GitHub: [Bhawna Sahu](https://github.com/Bhawna462/bhavna-ml-project)")
    st.markdown("🔗 LinkedIn: [Profile](https://www.linkedin.com/in/bhawna-sahu-534aa7306)")
    st.markdown("---")
